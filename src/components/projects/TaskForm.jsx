...
// Status options mapping for the dropdown
...
// Helper to fix Date reflection issues
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && filtered.length > 0 && (
        <div className="absolute z-[9999] top-9 left-0 w-56 bg-white border rounded-lg shadow-lg py-1 max-h-48 overflow-y-auto">
          {filtered.map(u => (
            <button
              key={u.email}
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-xs font-medium truncate">{u.first_name} {u.last_name}</p>
...
export default function TaskForm({ open, onClose, task, isPaidUser }) {
  ...
  // 1. Fetch employed personnels for assignee
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-xl max-h-[90vh] overflow-y-auto z-[9999] text-left">      
        <DialogHeader>
        ...
        <div className="space-y-4">
          <Input
            ...
            className="text-base font-bold border-0 border-b rounded-none px-0 shadow-none focus-visible:ring-0"
            autoFocus
          />
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            {/* Assignee Dropdown from HR Employees */}
            ...
            {/* Project List Selection Dropdown */}
